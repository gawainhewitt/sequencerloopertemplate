...
let carpet, seqOn, seqOff, seqStep1, seqStep2, grass, looper, looper2, performer1, performer2, performer3, performer4, performer5, performer6; // to store images in
...
function setup() {  // setup p5
  ...
  seqRowIncrement = height/10; // how close are the rows to each other?
  seqRowPosition = (height/7) * 4; // where is the sequencer positioned on the y axis?
